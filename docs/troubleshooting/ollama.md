...
**Tracking**: https://github.com/cryptdefender323/crypthunter/issues/..2. (closed - documented workaround)
...
- **oh-my-open-pentest**: https://github.com/cryptdefender323/crypthunter/issues/..2. (closed - workaround documented)
