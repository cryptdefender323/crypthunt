...
- [`omo` (oh-my-open-pentest)](https://github.com/cryptdefender323/crypthunter) — `src/tools/ast-grep/` is the original tool implementation; this skill is a port of its pattern-hint detection and two-pass-write strategy.
