...
3. Follow the `start-work` skill in full. The skill is already loaded from your earlier turn — re-read its file at `packages/omop-codex/plugin/skills/start-work/SKILL.md` if you have lost context.
