...
const CODEX_ROOT = join(REPO_ROOT, "packages", "omop-codex")
...
describe("omop-codex telemetry single-source guard", () => {
  describe("#given the omop-codex package tree", () => {
  ...
  describe("#given the built telemetry component bundle", () => {
    it("#when inspected #then telemetry-core is bundled self-contained into the runtime CLI", () => {
      ...
      expect(bundle).toContain("omop-codex:")
