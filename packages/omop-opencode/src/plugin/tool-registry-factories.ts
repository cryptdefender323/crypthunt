...
import {
  ...
  interactive_bash,
  createPentestTargetModelUpdateTool,
  createPentestHypothesizeTool,
...
export type ToolRegistryFactories = {
  ...
  // ── Reasoning Layer ──
  createPentestTargetModelUpdateTool: typeof createPentestTargetModelUpdateTool
  createPentestHypothesizeTool: typeof createPentestHypothesizeTool
  createPentestValidateTool: typeof createPentestValidateTool
