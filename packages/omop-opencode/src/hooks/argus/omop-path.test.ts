...
describe("isOmoPath", () => {
  test("#given a path under an omo directory #when checking the path #then it matches the omo segment", () => {
    expect(isOmoPath(".omop/plans/work.md")).toBe(true)
    expect(isOmoPath("/repo/.omop/plans/work.md")).toBe(true)
  ...
  test("#given a path whose directory merely ends with omo #when checking the path #then it does not match", () => {
    expect(isOmoPath("/repo/work.omop/plans/work.md")).toBe(false)
    expect(isOmoPath("/repo/.omop-backup/plans/work.md")).toBe(false)
