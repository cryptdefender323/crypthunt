...
import { CryptHunterConfigSchema, type CryptHunterConfig } from "./schema"
...
type LoadedConfigLayer = ConfigLayer & {
  readonly config: Partial<CryptHunterConfig> | null
  readonly messages: readonly string[]
}
...
function mergeLoadedConfig(
  ...
  let config = CryptHunterConfigSchema.parse({})
