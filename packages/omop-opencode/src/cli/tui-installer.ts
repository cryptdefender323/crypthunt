...
export async function runTuiInstaller(args: InstallArgs, version: string): Promise<number> {
  ...
  const asciiBanner = [
    ...
    "            @ rH# ## #########S3X; @@@@@@@@@@@@@@@@@@@ ....,,....,XM&@@@@@@@@@@@@@@@3   ,",
    "             .  :A    #######9##9##H5Xi: @@@@@@@@@@@@@      ;Xh#@@@@@@@@@@@@@@@@@Mr  .",
    "                . @,s3S##### ###9B&&B999#SHh52AXsrrrsX23H#&@@@@@@@@@@@@@@@@@@93i  .,",
    "                   .  @,r2M#### #9#B@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@S5i   .",
    "                     ,  @ @ ,rA3 #####9B@@@@@@@@@@@@@@@@@@@@@@@@@@@BG3s,  @@ .,",
    "                ,.   @   @@   @   .;sA3MG#9B@@@@@@@@@@@@@@@@BSh2r,      @ @@ @@@  .,",
    "            ,.     ..  @@@  @@@@@@,: @@ @ .:irsA3MMh35Asi: @ @  :     @ @ @@ .,:. @@@ .,",
    "         . @@ .:;i;.   @@@@@@@   @ 2h2s: @@@ @@@@@@@@@@@@@ .iX5Mr @     @ @     :ii:, @@ .",
    "          @@ ;iii:,,,   @@@@@     @ i5hhh5Xr,@@@@ @@@@ ;sAhMMhA: @@ :     @    ,,,:iii,@  .",
    "          , @ :ii;,,,,   @@@@@ .  @@ @ :::,.@@@@@@  @@@ .:;:, @ @ .;;         .,,,;ii.",
    "            .  .;ii:,,, @@ @@@ ....  @@@@@@@@@@@@ ;;:.  @   @@ .,:ir.     @  .,,,;i: @ ,",
    "             , @ :ii;,,, @@ @@  .  ..    @@@@@@@@ :::;;;:,..,,:;iir:      @  ,,,ii,@ .",
    "               .@ .iii:,. @ @@@@ .   @@@@@@@@@@   :::::::::::::::r;  @      ,,:i; @ ,",
  ...
  console.log(color.bold(color.magenta("  CryptHunter")) + color.dim(" — Autonomous Security Intelligence Engine"))
  console.log("")

  p.intro(color.bgMagenta(color.white(isUpdate ? " CryptHunter Update " : " CryptHunter ")))
  ...
  if (config.hasOpenCode) {
    ...
    if (config.hasOpenClaw) {
      p.log.info(
        `OpenClaw enabled. To let chat replies drive OpenCode sessions, set Discord/Telegram reply listener ` +
          `credentials manually under "openclaw.replyListener" in ${color.cyan(omoResult.configPath)}.`,
      )
    }
  }
  ...
  p.outro(color.green("CryptHunter... Let's hunt."))
