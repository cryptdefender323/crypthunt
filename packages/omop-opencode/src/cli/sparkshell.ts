...
export const SPARKSHELL_BIN_ENV = "OMOP_SPARKSHELL_BIN"
export const SPARKSHELL_CONDENSE_ENV = "OMOP_SPARKSHELL_CONDENSE"
export const SPARKSHELL_CONDENSE_BUDGET_ENV = "OMOP_SPARKSHELL_CONDENSE_BUDGET"
