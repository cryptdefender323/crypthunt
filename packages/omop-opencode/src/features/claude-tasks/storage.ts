...
export function getTaskDir(config: Partial<CryptHunterConfig> = {}): string {
...
export function resolveTaskListId(config: Partial<CryptHunterConfig> = {}): string {
...
export function listTaskFiles(config: Partial<CryptHunterConfig> = {}): string[] {
